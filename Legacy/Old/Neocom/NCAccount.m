...
- (EVEAPIKey*) eveAPIKey {
	__block EVEAPIKey* key;
	[self.managedObjectContext performBlockAndWait:^{
		key = [EVEAPIKey apiKeyWithKeyID:self.apiKey.keyID vCode:self.apiKey.vCode characterID:self.characterID corporate:self.accountType == NCAccountTypeCorporate];
	}];
	return key;
}
