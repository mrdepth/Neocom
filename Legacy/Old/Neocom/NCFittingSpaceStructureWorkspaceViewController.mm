//
//  NCFittingSpaceStructureWorkspaceViewController.m
//  Neocom
//
...
@interface NCFittingSpaceStructureWorkspaceViewController ()
...
@implementation NCFittingSpaceStructureWorkspaceViewController
...
- (NCFittingSpaceStructureViewController*) controller {
	return (NCFittingSpaceStructureViewController*) self.parentViewController;
}
