//
//  NCFittingAmountViewController.m
//  Neocom
//
...
@interface NCFittingAmountViewController ()

@end

@implementation NCFittingAmountViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
	if ([sender isKindOfClass:[UITableViewCell class]]) {
		...
		self.amount = indexPath.row + self.range.location;
	}
}
