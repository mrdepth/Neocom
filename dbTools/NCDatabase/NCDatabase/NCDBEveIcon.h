...
@class NCDBCertMasteryLevel, NCDBChrRace, NCDBDgmAttributeType, NCDBInvCategory, NCDBInvGroup, NCDBInvMarketGroup, NCDBInvMetaGroup, NCDBInvType, NCDBNpcGroup, NCDBRamActivity;
...
@property (nonatomic, retain) NCDBCertMasteryLevel *masteryLevelUnclaimedIcons;
