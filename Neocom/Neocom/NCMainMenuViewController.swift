		...
		var sections: [TreeNode] = [
			...
			DefaultTreeSection(nodeIdentifier: "Info", title: NSLocalizedString("Info", comment: "").uppercased(),
			                   children: [
								...
								NCMainMenuRow(nodeIdentifier: "BugReport", image: #imageLiteral(resourceName: "notepad"), title: NSLocalizedString("Bug Report", comment: ""), route: Router.MainMenu.BugReport())
				])
