...
@class EVEFittingFit;
@interface ModulesViewController : UIViewController<FittingSection, UITableViewDelegate, UITableViewDataSource, FittingItemsViewControllerDelegate, UIActionSheetDelegate, TargetsViewControllerDelegate> {
