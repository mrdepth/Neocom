...
print(UnitFormatter.localizedString(from: 12345678, unit: .none, style: .long))
print(UnitFormatter.localizedString(from: 123456.78, unit: .none, style: .long))
print(UnitFormatter.localizedString(from: 12.345678, unit: .none, style: .long))
print(UnitFormatter.localizedString(from: 1.2345678, unit: .none, style: .long))
